...
public class Constants {
    ...
    public static final String PROFILE_NAME = "DocumentCaptureProfile";
    ...
    public static final String 	COLUMN_SIGNATURE_STATUS  =  "field_signature_status";
    ...
    public static final int DOCUMENT_CAPTURE_SCANNING_MODE = 5;
    ...
    public static final String TARGET_FOLDER = "DocumentCaptureSample";
    public static final String ASSET_FILENAME = "SignatureAndAddressSeparately.xml";
}
